    ...
    return (
        <div>
            <section className="  relative w-full lg:h-full flex justify-start items-center mx-auto py-4 px-4 md:px-8">
                ...
                <div className="relative z-10 lg:gap-5 items-center lg:flex lg:w-2/5 ">
                    
                  
                    <div className=" flex-1 w-full py-5  sm:text-center lg:max-w-max lg:text-left">
                        <h3 className="lg:text-5xl text-4xl text-text-orange font-extrabold  ">
                          {prop.heading}
                        </h3>
                        <p className="text-white leading-relaxed text-lg my-8 font-semibold">
                                 {prop.description}  </p>
