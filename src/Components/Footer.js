...
export default () => {
  ...
  return (
      <footer className="pt-10 bg-black relative">
          <div className="max-w-screen-xl mx-auto px-4 md:px-8 ">
              <div className="justify-between items-center gap-12 md:flex">
                  <div className="flex-1 max-w-lg">
                      <h3 className="text-[#8D2813] text-2xl font-bold">
                       We build Stronger future for you.
                      </h3>
                  </div>
              
              </div>
              <div className=" grid lg:grid-rows-1 grid-rows-2 grid-cols-2 lg:grid-cols-4 mt-16 lg:space-y-6 justify-between sm:flex md:space-y-0">
                  {
                      footerNavs.map((item, idx) => (
                          <ul
                              className="space-y-4 my-5 text-gray-300"
                              key={idx}
                               
                          >
                              <h4 className=" text-text-orange font-semibold sm:pb-2">
                                  {item.label}
                              </h4>
                              {
