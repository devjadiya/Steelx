        ...
        background-size: cover;
            ...
            <section className="relative w-full bg-1 z-10 mx-auto lg:h-screen flex justify-center items-center py-4 px-4 md:px-8">
                ...
                <div className="relative z-10 gap-5 items-center lg:flex">
                    ...
                    <div className="flex lg:flex-row flex-col lg:w-full gap-y-5 lg:gap-y-0 mt-5 mx-auto sm:w-9/12 h-full lg:mt-0  w-screen">
                        <div className=' w-full lg:w-1/2 flex flex-col px-6  justify-center items-center gap-y-5'>
                        ...
                        <div className=' w-full lg:w-1/2 flex flex-col justify-center items-center px-6 gap-y-5'>
                            <div className=' rounded-2xl flex flex-col justify-center items-center p-3 bg-white shadow-md w-full h-40'>
